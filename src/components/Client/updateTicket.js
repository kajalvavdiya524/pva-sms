        ...
        <div className="mt-lg-4 mt-3  mx-lg-4 mx-3 px-4 py-lg-5 py-2  border-radius-10 box-shadow-gray">
          ...
          {ticket_data &&
            ...
            ticket_data.messages.map((data, i) => (
              ...
              >
                <span style={{padding:"0 10px" ,fontSize:"20px",fontWeight:"500", minWidth: "100px"}}>{data.user_type === 'admin'?"Admin :":"Me :"}</span>
                <span style={{ fontSize: "15px", padding: "5px 10px", width: "80%" }} dangerouslySetInnerHTML={{
                        __html: data.message,
                      }} >
                  {/* {data.message} */}
                </span>
